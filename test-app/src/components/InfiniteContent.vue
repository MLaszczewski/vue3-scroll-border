<template>
  <div class="scroll-area">
    <scroll-border :load="loadBottom" :drop="dropTop" :loadDelay="1000" placement="bottom"></scroll-border>
    ...
    <scroll-border :load="loadTop" :drop="dropTop" placement="top"></scroll-border>
  </div>
</template>
